...
class Ui_MainWindowBase(object):
    def setupUi(self, MainWindowBase):
        ...
        self.algorithmSettingsGroupBox = QtWidgets.QGroupBox(self.gridWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.algorithmSettingsGroupBox.sizePolicy().hasHeightForWidth())
        self.algorithmSettingsGroupBox.setSizePolicy(sizePolicy)
        self.algorithmSettingsGroupBox.setObjectName("algorithmSettingsGroupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.algorithmSettingsGroupBox)
        self.verticalLayout.setObjectName("verticalLayout")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.label_4 = QtWidgets.QLabel(self.algorithmSettingsGroupBox)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_7.addWidget(self.label_4)
        self.playbackDeltaSpinBox = QtWidgets.QSpinBox(self.algorithmSettingsGroupBox)
        ...
        self.pathCheckBox = QtWidgets.QCheckBox(self.algorithmSettingsGroupBox)
        ...
        self.reverseArrowColorCheckBox = QtWidgets.QCheckBox(self.algorithmSettingsGroupBox)
        self.reverseArrowColorCheckBox.setObjectName("reverseArrowColorCheckBox")
        self.verticalLayout.addWidget(self.reverseArrowColorCheckBox)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label = QtWidgets.QLabel(self.algorithmSettingsGroupBox)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.radiusSpinBox = QtWidgets.QSpinBox(self.algorithmSettingsGroupBox)
        ...
        self.label_2 = QtWidgets.QLabel(self.algorithmSettingsGroupBox)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.lineWidthSpinBox = QtWidgets.QSpinBox(self.algorithmSettingsGroupBox)
        ...
        self.label_3 = QtWidgets.QLabel(self.algorithmSettingsGroupBox)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_4.addWidget(self.label_3)
        self.overlayFrameNoSpinBox = QtWidgets.QSpinBox(self.algorithmSettingsGroupBox)
        ...
        self.verticalLayout.addWidget(self.opaqueCheckBox)
        self.horizontalLayout.addWidget(self.algorithmSettingsGroupBox)
    ...
    def retranslateUi(self, MainWindowBase):
        ...
        self.actionOpenFilterSetting.setText(_translate("MainWindowBase", "Open Filter"))
